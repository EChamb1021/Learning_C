/* Modify poker.c by moving num_in_rank and num_in_suit to main and passing them as arguments to
...
//Reads the cards into the variables num_in_rank and num_in_suit;
