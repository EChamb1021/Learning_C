        ...
        switch(step){
            case 0:
                if((row - 1) < 0 || array[row - 1][column] != '.'){
                    ...
                    array[row - 1][column] = (char) (letter + 1);
                    row -= 1;
                    letter += 1;
                    attempts = 1;
                }
            ...
            case 1: 
                if((column + 1) > (ARRAY_SIZE - 1) || array[row][column + 1] != '.'){
                    attempts += 1;
                    directions_tried[step] = true;
                    continue;
                }
                else{
                    array[row][column + 1] = (char) (letter + 1);
                    column += 1;
                    letter += 1;
                    attempts = 1;
                }
            ...
            case 2:
                if((row + 1) > (ARRAY_SIZE - 1) || array[row + 1][column] != '.'){
                    attempts += 1;
                    directions_tried[step] = true;
                    continue;
                }
