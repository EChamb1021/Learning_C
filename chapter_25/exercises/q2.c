...
Write a program that obtains the name of a locale from the command line and displays 
the values stored in the corresonding lconv structure
...
int main(int argc, char *argv[]){
  ...
  if(argc != 2){
    fprintf(stderr, "Usage: q2 [locale]\n");
    exit(EXIT_FAILURE);
  }
